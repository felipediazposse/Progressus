...
namespace ProgressusWebApi.Controllers.AuthControllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        [HttpGet("ObtenerRolDelUsuario")]
        public async Task<IActionResult> ObtenerRolDelUsuario([FromBody] string email)
        {
            return await _usuarioService.ObtenerRolesDelUsuario(email);
        }
